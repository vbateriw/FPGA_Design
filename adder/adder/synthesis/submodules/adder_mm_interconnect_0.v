...
module adder_mm_interconnect_0 (
	...
	wire  [91:0] cmd_mux_src_data;                                                                      // cmd_mux:src_data -> nios2_processor_debug_mem_slave_agent:cp_data
	...
	wire         cmd_mux_002_src_valid;                                                                 // cmd_mux_002:src_valid -> input_1_s1_agent:cp_valid
	wire  [91:0] cmd_mux_002_src_data;                                                                  // cmd_mux_002:src_data -> input_1_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                                 // input_1_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> input_1_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                         // cmd_mux_002:src_startofpacket -> input_1_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                           // cmd_mux_002:src_endofpacket -> input_1_s1_agent:cp_endofpacket
	wire  [31:0] output_y_s1_agent_m0_readdata;                                                         // output_y_s1_translator:uav_readdata -> output_y_s1_agent:m0_readdata
	wire         output_y_s1_agent_m0_waitrequest;                                                      // output_y_s1_translator:uav_waitrequest -> output_y_s1_agent:m0_waitrequest
	wire         output_y_s1_agent_m0_debugaccess;                                                      // output_y_s1_agent:m0_debugaccess -> output_y_s1_translator:uav_debugaccess
	wire  [15:0] output_y_s1_agent_m0_address;                                                          // output_y_s1_agent:m0_address -> output_y_s1_translator:uav_address
	wire   [3:0] output_y_s1_agent_m0_byteenable;                                                       // output_y_s1_agent:m0_byteenable -> output_y_s1_translator:uav_byteenable
	wire         output_y_s1_agent_m0_read;                                                             // output_y_s1_agent:m0_read -> output_y_s1_translator:uav_read
	wire         output_y_s1_agent_m0_readdatavalid;                                                    // output_y_s1_translator:uav_readdatavalid -> output_y_s1_agent:m0_readdatavalid
	wire         output_y_s1_agent_m0_lock;                                                             // output_y_s1_agent:m0_lock -> output_y_s1_translator:uav_lock
	wire  [31:0] output_y_s1_agent_m0_writedata;                                                        // output_y_s1_agent:m0_writedata -> output_y_s1_translator:uav_writedata
	wire         output_y_s1_agent_m0_write;                                                            // output_y_s1_agent:m0_write -> output_y_s1_translator:uav_write
	wire   [2:0] output_y_s1_agent_m0_burstcount;                                                       // output_y_s1_agent:m0_burstcount -> output_y_s1_translator:uav_burstcount
	wire         output_y_s1_agent_rf_source_valid;                                                     // output_y_s1_agent:rf_source_valid -> output_y_s1_agent_rsp_fifo:in_valid
	wire  [92:0] output_y_s1_agent_rf_source_data;                                                      // output_y_s1_agent:rf_source_data -> output_y_s1_agent_rsp_fifo:in_data
	wire         output_y_s1_agent_rf_source_ready;                                                     // output_y_s1_agent_rsp_fifo:in_ready -> output_y_s1_agent:rf_source_ready
	wire         output_y_s1_agent_rf_source_startofpacket;                                             // output_y_s1_agent:rf_source_startofpacket -> output_y_s1_agent_rsp_fifo:in_startofpacket
	wire         output_y_s1_agent_rf_source_endofpacket;                                               // output_y_s1_agent:rf_source_endofpacket -> output_y_s1_agent_rsp_fifo:in_endofpacket
	wire         output_y_s1_agent_rsp_fifo_out_valid;                                                  // output_y_s1_agent_rsp_fifo:out_valid -> output_y_s1_agent:rf_sink_valid
	wire  [92:0] output_y_s1_agent_rsp_fifo_out_data;                                                   // output_y_s1_agent_rsp_fifo:out_data -> output_y_s1_agent:rf_sink_data
	wire         output_y_s1_agent_rsp_fifo_out_ready;                                                  // output_y_s1_agent:rf_sink_ready -> output_y_s1_agent_rsp_fifo:out_ready
	wire         output_y_s1_agent_rsp_fifo_out_startofpacket;                                          // output_y_s1_agent_rsp_fifo:out_startofpacket -> output_y_s1_agent:rf_sink_startofpacket
	wire         output_y_s1_agent_rsp_fifo_out_endofpacket;                                            // output_y_s1_agent_rsp_fifo:out_endofpacket -> output_y_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                                 // cmd_mux_003:src_valid -> output_y_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                                  // cmd_mux_003:src_data -> output_y_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                                 // output_y_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                               // cmd_mux_003:src_channel -> output_y_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                         // cmd_mux_003:src_startofpacket -> output_y_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                           // cmd_mux_003:src_endofpacket -> output_y_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_004_src_valid;                                                                 // cmd_mux_004:src_valid -> input_2_s1_agent:cp_valid
	wire  [91:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> input_2_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                                 // input_2_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> input_2_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                         // cmd_mux_004:src_startofpacket -> input_2_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                           // cmd_mux_004:src_endofpacket -> input_2_s1_agent:cp_endofpacket
	...
	wire  [91:0] nios2_processor_debug_mem_slave_agent_rp_data;                                         // nios2_processor_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire         input_1_s1_agent_rp_valid;                                                             // input_1_s1_agent:rp_valid -> router_004:sink_valid
	wire  [91:0] input_1_s1_agent_rp_data;                                                              // input_1_s1_agent:rp_data -> router_004:sink_data
	wire         input_1_s1_agent_rp_ready;                                                             // router_004:sink_ready -> input_1_s1_agent:rp_ready
	wire         input_1_s1_agent_rp_startofpacket;                                                     // input_1_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         input_1_s1_agent_rp_endofpacket;                                                       // input_1_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         output_y_s1_agent_rp_valid;                                                            // output_y_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] output_y_s1_agent_rp_data;                                                             // output_y_s1_agent:rp_data -> router_005:sink_data
	wire         output_y_s1_agent_rp_ready;                                                            // router_005:sink_ready -> output_y_s1_agent:rp_ready
	wire         output_y_s1_agent_rp_startofpacket;                                                    // output_y_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         output_y_s1_agent_rp_endofpacket;                                                      // output_y_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         input_2_s1_agent_rp_valid;                                                             // input_2_s1_agent:rp_valid -> router_006:sink_valid
	wire  [91:0] input_2_s1_agent_rp_data;                                                              // input_2_s1_agent:rp_data -> router_006:sink_data
	wire         input_2_s1_agent_rp_ready;                                                             // router_006:sink_ready -> input_2_s1_agent:rp_ready
	wire         input_2_s1_agent_rp_startofpacket;                                                     // input_2_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         input_2_s1_agent_rp_endofpacket;                                                       // input_2_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         input_1_s1_agent_rdata_fifo_src_valid;                                                 // input_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] input_1_s1_agent_rdata_fifo_src_data;                                                  // input_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         input_1_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_002:in_0_ready -> input_1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                     // avalon_st_adapter_002:out_0_valid -> input_1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                      // avalon_st_adapter_002:out_0_data -> input_1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                     // input_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                     // avalon_st_adapter_002:out_0_error -> input_1_s1_agent:rdata_fifo_sink_error
	wire         output_y_s1_agent_rdata_fifo_src_valid;                                                // output_y_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] output_y_s1_agent_rdata_fifo_src_data;                                                 // output_y_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         output_y_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_003:in_0_ready -> output_y_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                     // avalon_st_adapter_003:out_0_valid -> output_y_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                      // avalon_st_adapter_003:out_0_data -> output_y_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                     // output_y_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                     // avalon_st_adapter_003:out_0_error -> output_y_s1_agent:rdata_fifo_sink_error
	wire         input_2_s1_agent_rdata_fifo_src_valid;                                                 // input_2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] input_2_s1_agent_rdata_fifo_src_data;                                                  // input_2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         input_2_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_004:in_0_ready -> input_2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                     // avalon_st_adapter_004:out_0_valid -> input_2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                      // avalon_st_adapter_004:out_0_data -> input_2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                     // input_2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                     // avalon_st_adapter_004:out_0_error -> input_2_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_main_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_processor_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (output_y_s1_agent_m0_address),                      // avalon_universal_slave_0.address
		.uav_burstcount         (output_y_s1_agent_m0_burstcount),                   //                         .burstcount
		.uav_read               (output_y_s1_agent_m0_read),                         //                         .read
		.uav_write              (output_y_s1_agent_m0_write),                        //                         .write
		.uav_waitrequest        (output_y_s1_agent_m0_waitrequest),                  //                         .waitrequest
		.uav_readdatavalid      (output_y_s1_agent_m0_readdatavalid),                //                         .readdatavalid
		.uav_byteenable         (output_y_s1_agent_m0_byteenable),                   //                         .byteenable
		.uav_readdata           (output_y_s1_agent_m0_readdata),                     //                         .readdata
		.uav_writedata          (output_y_s1_agent_m0_writedata),                    //                         .writedata
		.uav_lock               (output_y_s1_agent_m0_lock),                         //                         .lock
		.uav_debugaccess        (output_y_s1_agent_m0_debugaccess),                  //                         .debugaccess
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_main_clk_clk),                                  //             clk.clk
		.reset                   (nios2_processor_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (output_y_s1_agent_m0_address),                      //              m0.address
		.m0_burstcount           (output_y_s1_agent_m0_burstcount),                   //                .burstcount
		.m0_byteenable           (output_y_s1_agent_m0_byteenable),                   //                .byteenable
		.m0_debugaccess          (output_y_s1_agent_m0_debugaccess),                  //                .debugaccess
		.m0_lock                 (output_y_s1_agent_m0_lock),                         //                .lock
		.m0_readdata             (output_y_s1_agent_m0_readdata),                     //                .readdata
		.m0_readdatavalid        (output_y_s1_agent_m0_readdatavalid),                //                .readdatavalid
		.m0_read                 (output_y_s1_agent_m0_read),                         //                .read
		.m0_waitrequest          (output_y_s1_agent_m0_waitrequest),                  //                .waitrequest
		.m0_writedata            (output_y_s1_agent_m0_writedata),                    //                .writedata
		.m0_write                (output_y_s1_agent_m0_write),                        //                .write
		.rp_endofpacket          (output_y_s1_agent_rp_endofpacket),                  //              rp.endofpacket
		.rp_ready                (output_y_s1_agent_rp_ready),                        //                .ready
		.rp_valid                (output_y_s1_agent_rp_valid),                        //                .valid
		.rp_data                 (output_y_s1_agent_rp_data),                         //                .data
		.rp_startofpacket        (output_y_s1_agent_rp_startofpacket),                //                .startofpacket
		...
		.rf_sink_ready           (output_y_s1_agent_rsp_fifo_out_ready),              //         rf_sink.ready
		.rf_sink_valid           (output_y_s1_agent_rsp_fifo_out_valid),              //                .valid
		.rf_sink_startofpacket   (output_y_s1_agent_rsp_fifo_out_startofpacket),      //                .startofpacket
		.rf_sink_endofpacket     (output_y_s1_agent_rsp_fifo_out_endofpacket),        //                .endofpacket
		.rf_sink_data            (output_y_s1_agent_rsp_fifo_out_data),               //                .data
		.rf_source_ready         (output_y_s1_agent_rf_source_ready),                 //       rf_source.ready
		.rf_source_valid         (output_y_s1_agent_rf_source_valid),                 //                .valid
		.rf_source_startofpacket (output_y_s1_agent_rf_source_startofpacket),         //                .startofpacket
		.rf_source_endofpacket   (output_y_s1_agent_rf_source_endofpacket),           //                .endofpacket
		.rf_source_data          (output_y_s1_agent_rf_source_data),                  //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (output_y_s1_agent_rdata_fifo_src_ready),            //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (output_y_s1_agent_rdata_fifo_src_valid),            //                .valid
		.rdata_fifo_src_data     (output_y_s1_agent_rdata_fifo_src_data),             //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) output_y_s1_agent_rsp_fifo (
		.clk               (clk_main_clk_clk),                                  //       clk.clk
		.reset             (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (output_y_s1_agent_rf_source_data),                  //        in.data
		.in_valid          (output_y_s1_agent_rf_source_valid),                 //          .valid
		.in_ready          (output_y_s1_agent_rf_source_ready),                 //          .ready
		.in_startofpacket  (output_y_s1_agent_rf_source_startofpacket),         //          .startofpacket
		.in_endofpacket    (output_y_s1_agent_rf_source_endofpacket),           //          .endofpacket
		.out_data          (output_y_s1_agent_rsp_fifo_out_data),               //       out.data
		.out_valid         (output_y_s1_agent_rsp_fifo_out_valid),              //          .valid
		.out_ready         (output_y_s1_agent_rsp_fifo_out_ready),              //          .ready
		.out_startofpacket (output_y_s1_agent_rsp_fifo_out_startofpacket),      //          .startofpacket
		.out_endofpacket   (output_y_s1_agent_rsp_fifo_out_endofpacket),        //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	adder_mm_interconnect_0_router_002 router_003 (
	...
	adder_mm_interconnect_0_router_004 router_004 (
	...
	adder_mm_interconnect_0_router_004 router_005 (
		.sink_ready         (output_y_s1_agent_rp_ready),                        //      sink.ready
		.sink_valid         (output_y_s1_agent_rp_valid),                        //          .valid
		.sink_data          (output_y_s1_agent_rp_data),                         //          .data
		.sink_startofpacket (output_y_s1_agent_rp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (output_y_s1_agent_rp_endofpacket),                  //          .endofpacket
		.clk                (clk_main_clk_clk),                                  //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_router_004 router_006 (
	...
	adder_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_main_clk_clk),                                  //       clk.clk
		.reset               (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_main_clk_clk),                                  //       clk.clk
		.reset               (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_main_clk_clk),                                  //       clk.clk
		.reset               (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_main_clk_clk),                                  //       clk.clk
		.reset               (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_main_clk_clk),                                  //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_main_clk_clk),                                  //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_main_clk_clk),                                  //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_main_clk_clk),                                  //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_main_clk_clk),                                  //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adder_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_main_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (output_y_s1_agent_rdata_fifo_src_data),             //     in_0.data
		.in_0_valid     (output_y_s1_agent_rdata_fifo_src_valid),            //         .valid
		.in_0_ready     (output_y_s1_agent_rdata_fifo_src_ready),            //         .ready
