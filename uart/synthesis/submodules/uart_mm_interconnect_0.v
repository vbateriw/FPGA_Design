...
module uart_mm_interconnect_0 (
		...
		output wire [14:0] OCRAM_s1_address,                        //                          OCRAM_s1.address
	...
	wire  [94:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> NIOS2_debug_mem_slave_agent:cp_data
	...
	wire  [18:0] ocram_s1_agent_m0_address;                                                   // OCRAM_s1_agent:m0_address -> OCRAM_s1_translator:uav_address
	...
	wire  [95:0] ocram_s1_agent_rf_source_data;                                               // OCRAM_s1_agent:rf_source_data -> OCRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] ocram_s1_agent_rsp_fifo_out_data;                                            // OCRAM_s1_agent_rsp_fifo:out_data -> OCRAM_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> OCRAM_s1_agent:cp_valid
	wire  [94:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> OCRAM_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // OCRAM_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> OCRAM_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> OCRAM_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> OCRAM_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> UART_1_s1_agent:cp_valid
	wire  [94:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> UART_1_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // UART_1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> UART_1_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> UART_1_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> UART_1_s1_agent:cp_endofpacket
	...
	wire  [94:0] nios2_debug_mem_slave_agent_rp_data;                                         // NIOS2_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] ocram_s1_agent_rp_data;                                                      // OCRAM_s1_agent:rp_data -> router_004:sink_data
	...
	wire         uart_1_s1_agent_rp_valid;                                                    // UART_1_s1_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] uart_1_s1_agent_rp_data;                                                     // UART_1_s1_agent:rp_data -> router_007:sink_data
	wire         uart_1_s1_agent_rp_ready;                                                    // router_007:sink_ready -> UART_1_s1_agent:rp_ready
	wire         uart_1_s1_agent_rp_startofpacket;                                            // UART_1_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         uart_1_s1_agent_rp_endofpacket;                                              // UART_1_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [33:0] ocram_s1_agent_rdata_fifo_src_data;                                          // OCRAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	...
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> OCRAM_s1_agent:rdata_fifo_sink_data
	...
	wire         uart_1_s1_agent_rdata_fifo_src_valid;                                        // UART_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] uart_1_s1_agent_rdata_fifo_src_data;                                         // UART_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         uart_1_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_005:in_0_ready -> UART_1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> UART_1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> UART_1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // UART_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> UART_1_s1_agent:rdata_fifo_sink_error
	...
	uart_mm_interconnect_0_router_003 router_003 (
	...
	uart_mm_interconnect_0_router_003 router_004 (
	...
	uart_mm_interconnect_0_router_002 router_005 (
	...
	uart_mm_interconnect_0_router_002 router_006 (
	...
	uart_mm_interconnect_0_router_002 router_007 (
	...
	uart_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (CLK_50_clk_clk),                          //       clk.clk
		.reset               (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (CLK_50_clk_clk),                          //       clk.clk
		.reset               (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (CLK_50_clk_clk),                          //       clk.clk
		.reset               (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (CLK_50_clk_clk),                          //       clk.clk
		.reset               (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (CLK_50_clk_clk),                          //       clk.clk
		.reset               (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (CLK_50_clk_clk),                          //       clk.clk
		.reset              (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (CLK_50_clk_clk),                          //       clk.clk
		.reset              (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (CLK_50_clk_clk),                          //       clk.clk
		.reset              (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (CLK_50_clk_clk),                          //       clk.clk
		.reset              (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
